...
! function(a) {
    ...
    e.DEFAULTS = {
        ...
        var b = this;
        this.$btnToolbar = a('<div class="btn-toolbar" />'), this.$dropdownGroup = a('<div class="btn-group dropdown-btn-group pull-right" />'), this.$dropdownBtn = a('<button class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown">Display <span class="caret"></span></button>'), this.$dropdownContainer = a('<ul class="dropdown-menu"/>'), this.options.addFocusBtn && (this.$focusGroup = a('<div class="btn-group focus-btn-group" />'), this.$focusBtn = a('<button class="btn btn-outline-secondary">Focus</button>'), this.options.focusBtnIcon && this.$focusBtn.prepend('<span class="' + this.options.focusBtnIcon + '"></span> '), this.$focusGroup.append(this.$focusBtn), this.$btnToolbar.append(this.$focusGroup), this.$focusBtn.click(function() {
            a.proxy(b.activateFocus(), b)
        }), this.$bodyRows.click(function() {
            a.proxy(b.focusOnRow(a(this)), b)
        })), this.options.addDisplayAllBtn && (this.$displayAllBtn = a('<button class="btn btn-outline-secondary">Display all</button>'), this.$dropdownGroup.append(this.$displayAllBtn), this.$table.hasClass("display-all") && this.$displayAllBtn.addClass("btn-secondary"), this.$displayAllBtn.click(function() {
        ...
        this.clearAllFocus(), this.$focusBtn && this.$focusBtn.toggleClass("btn-secondary"), this.$table.toggleClass("focus-on")
        ...
        this.$displayAllBtn && this.$displayAllBtn.toggleClass("btn-secondary", b), this.$table.toggleClass("display-all", b), this.$tableClone && this.$tableClone.toggleClass("display-all", b), c && a(window).trigger(this.displayAllTrigger)
